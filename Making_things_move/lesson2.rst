...
``P1`` of the pendulum in :math:`x`, :math:`y` and :math:`z`, i.e. two DoFs more
...
.. note:: See `Andersen MS, Damsgaard M, and Rasmussen J. 2007 <http://www.tandfonline.com/doi/abs/10.1080/10255840802459412>`_ 
